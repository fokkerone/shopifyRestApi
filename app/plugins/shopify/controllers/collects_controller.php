 ...
 */
class CollectsController extends ShopifyAppController {
   ...
   */
	public function index() {
	 	debug ($this->Collect->find('count', array("vendor" => "fokkerone")));
    	$collects = $this->Collect->find('list');
  ...
  public function add( $xml ) {	
	 $products = $this->Collect->create( $xml );
  }
   ...
   */
	public function view( $id ) {
    	$product = $this->Collect->find('list', array("id" => $id));
